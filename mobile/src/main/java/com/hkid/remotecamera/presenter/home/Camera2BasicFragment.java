...
//            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile));
            ...
            if(mImage != null){
                ...
                new Thread(() -> {
                    ...
                    Bitmap bmpSmallRotated = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, false);
...
//                        });
    ...
    private void sendToWearable(String path, byte[] data, ResultCallback<MessageApi.SendMessageResult> callback){
        if(mNode != null){
            PendingResult<MessageApi.SendMessageResult> pendingResult = Wearable.MessageApi.sendMessage(mGoogleApiClient, mNode.getId(), path, data);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mCameraOrientation = (ORIENTATIONS.get(degrees) + mSensorOrientation + 270) % 360;
